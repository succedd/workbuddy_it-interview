...
- **线上**：main（Pages 实际发布源）= release = **346 题**数据 + `20260829x`（自动备份死循环 + 再面一次按钮均已修复上线）；sitemap.xml 351 条已修复上线（含 341–346）；smoke-test 26/26；编辑端双推与自愈已在真实使用中验证
