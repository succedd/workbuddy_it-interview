...
async function pageHelp() {
  ...
  setMain(`
    ...
    `)}
    ${sec("find", "🔍 找题与浏览", `
      ${li("搜索", "顶栏 / 首页搜索框支持标题、标签、岗位、分类名；输入框聚焦会弹出最近搜索和热门词。手机上顶栏也保留一个放大镜入口，点它直接展开搜索，不必先拉出侧栏")}
    ...
    `)}
    <div class="muted" style="text-align:center;font-size:12px;margin-top:18px">文档最近更新：2026-09-24 · 更详细的开发文档见 GitHub 仓库 README</div>
  `);
