...
async function pageHelp() {
  ...
  setMain(`
    ...
    ${sec("find", "🔍 找题与浏览", `
      ...
      ${li("技术体系", "279 个分类的树状目录，逐层展开找题；点开任一分类有「技术全景图」：顶部「架构图 / 分支树」两个按钮可来回切换视图——架构图：重点域配有人工分层架构图，节点与分支树末级均可点击直达分类，薄弱分类橙色标记；分支树：该分类及全部子分类的题量分布树，点节点直达题目列表")}
    ...
    `)}
    <div class="muted" style="text-align:center;font-size:12px;margin-top:18px">文档最近更新：2026-09-11 · 更详细的开发文档见 GitHub 仓库 README</div>
  `);
